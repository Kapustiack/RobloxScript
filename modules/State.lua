...
getgenv().followUsePathfinding = false
getgenv().noclipPreset = "both"
getgenv().freeCamCollision = false
getgenv().flightSoftMode = false
getgenv().noDamageFallPatterns = {"fall", "land", "ragdoll", "impact", "damage", "velocity"}
