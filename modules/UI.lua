...
getgenv().COL_ON = COL_ON; getgenv().COL_OFF = COL_OFF
...
getgenv().HudLabel = Instance.new("TextLabel"); HudLabel.Parent = HudFrame; HudLabel.BackgroundTransparency = 1; HudLabel.Size = UDim2.new(1, 0, 1, 0); HudLabel.Font = Enum.Font.GothamBold; HudLabel.TextSize = 11; HudLabel.TextColor3 = COL_TXT; HudLabel.RichText = true; HudLabel.Text = "FPS: -- | Ping: --ms"; HudLabel.TextXAlignment = Enum.TextXAlignment.Center
...
local function makeBtn(n,t,c,r)
    local PAD, BH, GAP, BW = 12, 28, 8, (380 - 12*2 - 8) / 2
    local b = Instance.new("TextButton"); b.Name = n; b.Parent = ContentScroll; b.BackgroundColor3 = COL_OFF; b.BorderSizePixel = 0; b.Position = UDim2.new(0, PAD + (c-1)*(BW+8), 0, PAD + (r-1)*(BH+GAP)); b.Size = UDim2.new(0, BW, 0, BH); b.Font = Enum.Font.Gotham; b.Text = t; b.TextColor3 = COL_TXT; b.TextSize = 12; Instance.new("UICorner", b).CornerRadius = UDim.new(0, 6)
...
getgenv().TipLabel = Instance.new("TextLabel"); TipLabel.Parent = ContentScroll; TipLabel.BackgroundTransparency = 1; TipLabel.Position = UDim2.new(0, 12, 0, (12 + (9-1)*(28+8)) + 28 + 6); TipLabel.Size = UDim2.new(1, -24, 0, 14); TipLabel.Font = Enum.Font.Gotham; TipLabel.Text = "Ctrl+Click = Teleport | Right-click = Settings | Shift+C = Hide"; TipLabel.TextColor3 = COL_MUTE; TipLabel.TextSize = 10; TipLabel.TextXAlignment = Enum.TextXAlignment.Center
...
local function makePanel(name, title, w, h)
    local f = Instance.new("Frame"); f.Name = name; f.Parent = ScreenGui; f.BackgroundColor3 = Color3.fromRGB(16, 16, 23); f.BorderSizePixel = 0; f.Position = UDim2.new(0.5, -w/2, 0.5, -h/2); f.Size = UDim2.new(0, w, 0, h); f.Visible = false; f.Active = true; f.Draggable = true; Instance.new("UICorner", f).CornerRadius = UDim.new(0, 8); local s = Instance.new("UIStroke", f); s.Color = Color3.fromRGB(38, 38, 54); s.Thickness = 1; local tb = Instance.new("Frame"); tb.Parent = f; tb.BackgroundColor3 = Color3.fromRGB(10, 10, 16); tb.BorderSizePixel = 0; tb.Size = UDim2.new(1, 0, 0, 30); Instance.new("UICorner", tb).CornerRadius = UDim.new(0, 8); local tl = Instance.new("TextLabel"); tl.Parent = tb; tl.BackgroundTransparency = 1; tl.Size = UDim2.new(1, -34, 1, 0); tl.Position = UDim2.new(0, 10, 0, 0); tl.Font = Enum.Font.GothamBold; tl.Text = title; tl.TextColor3 = COL_TXT; tl.TextSize = 11; tl.TextXAlignment = Enum.TextXAlignment.Left; local cb = Instance.new("TextButton"); cb.Parent = tb; cb.BackgroundColor3 = COL_CLO; cb.BorderSizePixel = 0; cb.Position = UDim2.new(1, -24, 0.5, -8); cb.Size = UDim2.new(0, 16, 0, 16); cb.Font = Enum.Font.GothamBold; cb.Text = "X"; cb.TextColor3 = Color3.new(1,1,1); cb.TextSize = 11; Instance.new("UICorner", cb).CornerRadius = UDim.new(0, 4); cb.MouseButton1Click:Connect(function() f.Visible = false end); return f
end
local function pBtn(p, n, t, x, y, w, h)
    local b = Instance.new("TextButton"); b.Name = n; b.Parent = p; b.BackgroundColor3 = COL_OFF; b.BorderSizePixel = 0; b.Position = UDim2.new(0, x, 0, y); b.Size = UDim2.new(0, w, 0, h or 26); b.Font = Enum.Font.Gotham; b.Text = t; b.TextColor3 = COL_TXT; b.TextSize = 11; Instance.new("UICorner", b).CornerRadius = UDim.new(0, 5); return b
end
local function pLabel(p, n, t, x, y, w, h)
    local l = Instance.new("TextLabel"); l.Name = n; l.Parent = p; l.BackgroundColor3 = Color3.fromRGB(22, 22, 32); l.BorderSizePixel = 0; l.Position = UDim2.new(0, x, 0, y); l.Size = UDim2.new(0, w, 0, h or 24); l.Font = Enum.Font.Gotham; l.Text = t; l.TextColor3 = COL_TXT; l.TextSize = 11; Instance.new("UICorner", l).CornerRadius = UDim.new(0, 5); return l
end
local function pSlider(p, n, x, y, w)
    local s = Instance.new("TextButton"); s.Name = n; s.Parent = p; s.BackgroundColor3 = Color3.fromRGB(38, 38, 54); s.BorderSizePixel = 0; s.Position = UDim2.new(0, x, 0, y); s.Size = UDim2.new(0, w, 0, 14); s.Font = Enum.Font.Gotham; s.Text = ""; Instance.new("UICorner", s).CornerRadius = UDim.new(0, 7); return s
end
