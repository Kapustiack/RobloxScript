...
-- FIX: Re-enabling flight while seated no longer ejects the character.
--      PlatformStand is only set when the player is NOT in a seat.
...
local function enableFlight()
    ...
    -- SEAT FIX: setting PlatformStand=true while seated destroys the weld and ejects the player.
    -- Skip it when already in a seat; BodyVelocity still gives full flight control.
